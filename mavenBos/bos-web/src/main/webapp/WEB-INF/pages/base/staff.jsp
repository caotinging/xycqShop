...
<script type="text/javascript">
	...
	//shiro页面标签：没有staff-delete权限的用户页面不会显示作废按钮
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="对收派员进行添加或者修改" id="addStaffWindow"
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="addStaffForm" action="${pageContext.request.contextPath }/staffAction_saveStaff">
						...
						<td>
							<script type="text/javascript">
								$(function() {
									$("#save").click(function(){
										//表单提交校验
										var res = $("#addStaffForm").form('validate');
