...
<!-- Bootstrap styles -->
<link rel="stylesheet" href="${pageContext.request.contextPath }/js/file-upload/bootstrap-3.2.0/css/bootstrap.min.css">
<!-- Generic page styles -->
<link rel="stylesheet" href="${pageContext.request.contextPath }/js/file-upload/css/style.css">
<!-- blueimp Gallery styles -->
<link rel="stylesheet" href="${pageContext.request.contextPath }/js/file-upload/gallery/css/blueimp-gallery.min.css">
<!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
<link rel="stylesheet" href="${pageContext.request.contextPath }/js/file-upload/css/jquery.fileupload.css">
<link rel="stylesheet" href="${pageContext.request.contextPath }/js/file-upload/css/jquery.fileupload-ui.css">
